...
async def send_verification_email(to_email: str, verification_token: str, user_name: str | None = None) -> bool:
    ...
    <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; border-radius: 10px 10px 0 0; text-align: center;">
            <h1 style="color: white; margin: 0; font-size: 28px;">PromptLab</h1>
        </div>
        <div style="background: #ffffff; padding: 30px; border: 1px solid #e0e0e0; border-top: none; border-radius: 0 0 10px 10px;">
            <h2 style="color: #333; margin-top: 0;">Verify your email address</h2>
            <p>{greeting},</p>
            <p>Thanks for signing up for PromptLab! Please verify your email address by clicking the button below:</p>
            ...
            <p style="color: #999; font-size: 12px; margin-bottom: 0;">This link will expire in 24 hours. If you didn't create an account with PromptLab, you can safely ignore this email.</p>
        </div>
    </body>
    </html>
    """
...
Thanks for signing up for PromptLab! Please verify your email address by clicking the link below:

{verification_url}

This link will expire in 24 hours.

If you didn't create an account with PromptLab, you can safely ignore this email.
...
"""
    ...
    return await send_email(
        to_email=to_email,
        subject="Verify your PromptLab email address",
